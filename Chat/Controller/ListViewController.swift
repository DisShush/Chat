...
class ListViewController: UIViewController {
    ...
    enum Section: Int, CaseIterable {
        ...
        func description() -> String {
            switch self {
            case .waitingChats:
                return "Ожидающие беседы"
            case .activeChats:
                return "Активные беседы"
            }
        }
    }
...
extension ListViewController: WaitingChatsNavigation {
    func removeWaitingChat(chat: MChat) {
        FireStoreServices.shared.deleteWaitingChat(chat: chat) { (result) in
            switch result {
            case .success:
    ...
    func changeToActive(chat: MChat) {
        print(#function)
        FireStoreServices.shared.changeToActive(chat: chat) { (result) in
            switch result {
            case .success:

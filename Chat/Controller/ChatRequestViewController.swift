...
class ChatRequestViewController: UIViewController {
    ...
    let acceptButton = UIButton(title: "Подтвердить", backgroundColor: .black, titleColor: .white, font: .laoSangamMN20(), isShadow: false, cornerRadius: 10)
    let denyButton = UIButton(title: "Отказать", backgroundColor: .mainWhite(), titleColor: #colorLiteral(red: 0.8352941176, green: 0.2, blue: 0.2, alpha: 1),  font: .laoSangamMN20(), isShadow: false, cornerRadius: 10)
